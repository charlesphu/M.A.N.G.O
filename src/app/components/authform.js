...
export default function AuthForm({ orbitron }) {
  ...
  return (
    ...
    >
      ...
      >
        <h1 style={{ fontSize: "2rem", textAlign: "center" }}>{isLoginOrSignUp}</h1>
        ...
        <div style={{ textAlign: "center" }}>
          <span
            ...
            onClick={() =>
              setIsLoginOrSignUp(isLoginOrSignUp === "Login" ? "Sign Up" : "Login")
            }
          >
            {signInOrSignUpText}
          </span>
